import{V as B,C as W,r as N,s as C}from"./index-BaQBt8WL.js";class U{parse(j){let r="",u=0,v=0,A=0;const o=new B,g=new W,d=new B,M=new N,y=[];function w(e){let m=0,x=0,l=0;const f=e.geometry,t=new C,i=f.getAttribute("position"),s=f.getAttribute("normal"),p=f.getAttribute("uv"),V=f.getIndex();if(r+="o "+e.name+`
...
//# sourceMappingURL=OBJExporter-Pj8Phza4.js.map
